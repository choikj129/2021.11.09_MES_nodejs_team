...
function now(){
    ...
    function(result){
        ...
        $("#qnt").text((result.monitor.cnt/result.monitor.total*100).toFixed(2)+"%")
        $("#def").text((result.monitor.def/result.monitor.cnt*100).toFixed(2)+"%")
        if(result.process=="ready"){
        ...
        }else if(result.process=="injecting"){
        ...
        }else if(result.process=="filling"){
            $("#b3").css("background-color", "yellow")
        }else if(result.process=="holding"){
            $("#b4").css("background-color", "yellow")
        ...
        }else if(result.process=="seperating"){
            $("#b5").css("background-color", "yellow")
            if(error!=""){
